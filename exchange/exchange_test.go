...
func TestNewExchange(t *testing.T) {
	...
	e := NewExchange(adapters, nil, cfg, map[string]usersync.Syncer{}, &metricsConf.NilMetricsEngine{}, biddersInfo, gdprPermsBuilder, tcf2ConfigBuilder, currencyConverter, nilCategoryFetcher{}, &adscert.NilSigner{}, task.NewDealFetcher(&http.Client{}, config.BidderInfos{})).(*exchange)
...
func TestGetBidCacheInfoEndToEnd(t *testing.T) {
	...
	e := NewExchange(adapters, pbc, cfg, map[string]usersync.Syncer{}, &metricsConf.NilMetricsEngine{}, biddersInfo, gdprPermsBuilder, tcf2ConfigBuilder, currencyConverter, nilCategoryFetcher{}, &adscert.NilSigner{}, task.NewDealFetcher(&http.Client{}, config.BidderInfos{})).(*exchange)
	// 	3) Build all the parameters e.buildBidResponse(ctx.Background(), liveA... ) needs
...
func TestBidResponseImpExtInfo(t *testing.T) {
	...
	e := NewExchange(adapters, nil, cfg, map[string]usersync.Syncer{}, &metricsConf.NilMetricsEngine{}, nil, gdprPermsBuilder, tcf2ConfigBuilder, nil, nilCategoryFetcher{}, &adscert.NilSigner{}, task.NewDealFetcher(&http.Client{}, config.BidderInfos{})).(*exchange)
...
func TestRaceIntegration(t *testing.T) {
	...
	ex := NewExchange(adapters, &wellBehavedCache{}, cfg, map[string]usersync.Syncer{}, &metricsConf.NilMetricsEngine{}, biddersInfo, gdprPermsBuilder, tcf2CfgBuilder, currencyConverter, &nilCategoryFetcher{}, &adscert.NilSigner{}, task.NewDealFetcher(&http.Client{}, config.BidderInfos{})).(*exchange)
...
func TestPanicRecoveryHighLevel(t *testing.T) {
	...
	e := NewExchange(adapters, &mockCache{}, cfg, map[string]usersync.Syncer{}, &metricsConf.NilMetricsEngine{}, biddersInfo, gdprPermsBuilder, tcf2ConfigBuilder, currencyConverter, categoriesFetcher, &adscert.NilSigner{}, task.NewDealFetcher(&http.Client{}, config.BidderInfos{})).(*exchange)
...
func TestPassExperimentConfigsToHoldAuction(t *testing.T) {
	...
	e := NewExchange(adapters, nil, cfg, map[string]usersync.Syncer{}, &metricsConf.NilMetricsEngine{}, biddersInfo, gdprPermsBuilder, tcf2ConfigBuilder, currencyConverter, nilCategoryFetcher{}, &signer, task.NewDealFetcher(&http.Client{}, config.BidderInfos{})).(*exchange)
