...
func New(cfg *config.Configuration, rateConvertor *currency.RateConverter, dealFetcher *task.DealFetcher) (r *Router, err error) {
	...
	theExchange := exchange.NewExchange(adapters, cacheClient, cfg, syncersByBidder, r.MetricsEngine, cfg.BidderInfos, gdprPermsBuilder, tcf2CfgBuilder, rateConvertor, categoriesFetcher, adsCertSigner, dealFetcher)
